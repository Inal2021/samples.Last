 ...
 */
            ...
            static int water = 1500, milk = 500, coffeeBeans = 150, disposableCups = 10, money = 2;
            ...
            public static void espresso(int cup) {
                ...
                // needs 250 water--16 coffee beans -- cost $2
                ...
                if (250 * cup < water && 16 * cup < coffeeBeans && cup < disposableCups) {
                    ...
                    coffeeBeans -= 16 * cup;
                    disposableCups -= cup;
                    money += 2 * cup;//adding to the value
                    remaining();
                }
            }
...
// needs 350 water -- 75 milk -- 20 coffee beans --cost $4
...
// needs 200 = water -- 100 = milk -- 12 = coffee beans -- cost $3
